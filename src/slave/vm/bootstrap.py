...
class TalusCodeImporter(object):
    ...
    def __init__(self, loc, username, password, parent_log=None):
        ...
        self._log.info('self.loc = {}\nself.pypi_loc = {}\nusername = {}\npassword = {}\n'.
                       format(self.loc, self.pypi_loc, self.username, self.password))
        ...
        self._log.info('self._code_dir = {}'.format(self._code_dir))
        ...
        self._log.info('self._pypi_dir = {}'.format(self._pypi_dir))
        ...
        self._log.info('site.USER_SITE = {}'.format(site.USER_SITE))
        ...
        # these are python packages that are stored in git (and aren't cacheable in our
        # own pypi)
